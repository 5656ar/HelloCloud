...
@app.route('/')
def index():
    result = session.query(Students_table.student_id,Students_table.f_name,Registration_table.subject_id,Subject_table.subject_name,Registration_table.grade,Teachers_table.f_tname,Teachers_table.l_tname)\
